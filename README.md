...
VLAN10からWEB01へのHTTP通信のみ許可し、ICMPおよびDB01への通信を拒否できることを確認しました。

![ACL Test](evidence/acl-test.png)

### SSH試験

VLAN99からのSSHを許可し、VLAN10 / VLAN30からのSSHを拒否できることを確認しました。

![SSH Test](evidence/ssh-test.png)
